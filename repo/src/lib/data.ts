...
export const PLATFORMS: Platform[] = [
  // ── Food Delivery ──────────────────────────────────────────────────────────
  { id: "uber-eats", name: "Food Platform 1", category: "food", regions: ["north-america", "europe", "india", "sea", "mena", "latin-america", "oceania"], color: "text-emerald-400", bgColor: "bg-emerald-500/10", borderColor: "border-emerald-500/30", icon: "🟢", connected: true, notificationsToday: 24, earningsToday: 87.50, currency: "USD" },
  { id: "doordash", name: "Food Platform 2", category: "food", regions: ["north-america", "oceania"], color: "text-red-400", bgColor: "bg-red-500/10", borderColor: "border-red-500/30", icon: "🔴", connected: true, notificationsToday: 18, earningsToday: 62.30, currency: "USD" },
  { id: "grubhub", name: "Food Platform 3", category: "food", regions: ["north-america"], color: "text-yellow-400", bgColor: "bg-yellow-500/10", borderColor: "border-yellow-500/30", icon: "🟡", connected: false, notificationsToday: 8, earningsToday: 31.20, currency: "USD" },
  { id: "deliveroo", name: "Food Platform 4", category: "food", regions: ["europe", "mena", "sea"], color: "text-teal-400", bgColor: "bg-teal-500/10", borderColor: "border-teal-500/30", icon: "🦘", connected: true, notificationsToday: 15, earningsToday: 48.00, currency: "EUR" },
  { id: "just-eat", name: "Food Platform 5", category: "food", regions: ["europe"], color: "text-orange-400", bgColor: "bg-orange-500/10", borderColor: "border-orange-500/30", icon: "🟠", connected: false, notificationsToday: 12, earningsToday: 42.50, currency: "EUR" },
  { id: "foodpanda", name: "Food Platform 8", category: "food", regions: ["sea", "mena", "east-asia"], color: "text-pink-400", bgColor: "bg-pink-500/10", borderColor: "border-pink-500/30", icon: "🐼", connected: false, notificationsToday: 10, earningsToday: 35.00, currency: "SGD" },
  { id: "swiggy", name: "Food Platform 9", category: "food", regions: ["india"], color: "text-amber-400", bgColor: "bg-amber-500/10", borderColor: "border-amber-500/30", icon: "🔥", connected: true, notificationsToday: 22, earningsToday: 1200, currency: "INR" },
  { id: "zomato", name: "Food Platform 10", category: "food", regions: ["india"], color: "text-red-400", bgColor: "bg-red-500/10", borderColor: "border-red-500/30", icon: "🍅", connected: true, notificationsToday: 19, earningsToday: 980, currency: "INR" },
  { id: "ifood", name: "Food Platform 11", category: "food", regions: ["latin-america"], color: "text-purple-400", bgColor: "bg-purple-500/10", borderColor: "border-purple-500/30", icon: "🟣", connected: false, notificationsToday: 14, earningsToday: 85.00, currency: "BRL" },
  { id: "rappi", name: "Food Platform 12", category: "food", regions: ["latin-america"], color: "text-orange-400", bgColor: "bg-orange-500/10", borderColor: "border-orange-500/30", icon: "🟧", connected: false, notificationsToday: 11, earningsToday: 65.00, currency: "COP" },
  { id: "wolt", name: "Food Platform 13", category: "food", regions: ["europe", "mena", "east-asia"], color: "text-sky-400", bgColor: "bg-sky-500/10", borderColor: "border-sky-500/30", icon: "🔵", connected: false, notificationsToday: 9, earningsToday: 38.00, currency: "EUR" },
  { id: "glovo", name: "Food Platform 14", category: "food", regions: ["europe", "mena", "sea"], color: "text-yellow-400", bgColor: "bg-yellow-500/10", borderColor: "border-yellow-500/30", icon: "🟨", connected: false, notificationsToday: 7, earningsToday: 28.00, currency: "EUR" },
...
export const PICKUP_LOCATIONS: Record<string, string[]> = {
  ...
  "india": [
    "Food Platform 9 - Koramangala", "Food Platform 10 - HSR Layout", "DMart - Whitefield",
    "Grocery Hub - Electronic City", "Apollo Pharmacy - MG Road", "MedPlus - Jubilee Hills",
