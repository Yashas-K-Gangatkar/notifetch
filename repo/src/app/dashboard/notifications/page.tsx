...
const SOURCE_CONFIG: Record<string, { color: string; bgColor: string; label: string }> = {
  ...
  dunzo: { color: "text-emerald-500", bgColor: "bg-emerald-500/10", label: "Package Platform 3" },
  porter: { color: "text-blue-500", bgColor: "bg-blue-500/10", label: "Package Platform 4" },
  rapido: { color: "text-yellow-500", bgColor: "bg-yellow-500/10", label: "Ride Platform 1" },
  ola: { color: "text-teal-500", bgColor: "bg-teal-500/10", label: "Ride Platform 2" },
  uber: { color: "text-gray-500", bgColor: "bg-gray-500/10", label: "Ride Platform 3" },
  flipkart: { color: "text-blue-500", bgColor: "bg-blue-500/10", label: "Package Platform 2" },
  shadowfax: { color: "text-orange-500", bgColor: "bg-orange-500/10", label: "Package Platform 6" },
