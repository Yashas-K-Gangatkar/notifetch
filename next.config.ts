...
const securityHeaders = [
  ...
  // Content Security Policy
  {
    ...
    value: [
      ...
      "connect-src 'self' https://api.resend.com https://*.googleapis.com https://*.google.com https://*.razorpay.com https://api.razorpay.com",
      "frame-src https://js.stripe.com https://*.google.com https://api.razorpay.com https://checkout.razorpay.com",
