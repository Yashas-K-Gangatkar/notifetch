#!/bin/bash
# DeliveryBoost - Full Project Setup Script
# Run this inside your cloned d2 repo after creating the Next.js app

set -e

echo "🚀 Setting up DeliveryBoost source files..."
...
export const PLATFORMS: Platform[] = [
  { id: "uber-eats", name: "Uber Eats", color: "text-emerald-400", bgColor: "bg-emerald-500/10", borderColor: "border-emerald-500/30", icon: "🟢", connected: true, notificationsToday: 24, earningsToday: 87.50 },
  { id: "doordash", name: "DoorDash", color: "text-red-400", bgColor: "bg-red-500/10", borderColor: "border-red-500/30", icon: "🔴", connected: true, notificationsToday: 18, earningsToday: 62.30 },
  { id: "instacart", name: "Instacart", color: "text-orange-400", bgColor: "bg-orange-500/10", borderColor: "border-orange-500/30", icon: "🟠", connected: true, notificationsToday: 12, earningsToday: 45.80 },
  { id: "grubhub", name: "Grubhub", color: "text-yellow-400", bgColor: "bg-yellow-500/10", borderColor: "border-yellow-500/30", icon: "🟡", connected: false, notificationsToday: 8, earningsToday: 31.20 },
  { id: "amazon-flex", name: "Amazon Flex", color: "text-teal-400", bgColor: "bg-teal-500/10", borderColor: "border-teal-500/30", icon: "🔵", connected: true, notificationsToday: 6, earningsToday: 52.40 },
];
...
export const PICKUP_LOCATIONS = [
  ...
  "Costco - Warehouse Blvd", "Pizza Hut - Valley Rd", "Subway - Station Ave",
];
...
echo "✅ src/lib/data.ts created"

# ===== Components =====
mkdir -p src/components

# Read each component from the sandbox and write it
