  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(2) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS `platform_configs` (`packageName` TEXT NOT NULL, `displayName` TEXT NOT NULL, `customDisplayName` TEXT, `isEnabled` INTEGER NOT NULL, `notificationCount` INTEGER NOT NULL, `lastNotificationAt` INTEGER, PRIMARY KEY(`packageName`))");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'cd9435dc6ffee75e4c6d186f2eac2060')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        final HashMap<String, TableInfo.Column> _columnsCapturedNotifications = new HashMap<String, TableInfo.Column>(18);
        ...
        final HashSet<TableInfo.Index> _indicesCapturedNotifications = new HashSet<TableInfo.Index>(4);
        ...
        final HashMap<String, TableInfo.Column> _columnsPlatformConfigs = new HashMap<String, TableInfo.Column>(6);
    ...
    }, "cd9435dc6ffee75e4c6d186f2eac2060", "94278607ac743f99f587cc2cfc476279");
