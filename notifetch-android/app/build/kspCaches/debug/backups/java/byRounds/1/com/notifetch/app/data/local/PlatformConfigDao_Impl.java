  ...
  public PlatformConfigDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfPlatformConfig = new EntityInsertionAdapter<PlatformConfig>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `platform_configs` (`packageName`,`displayName`,`customDisplayName`,`isEnabled`,`notificationCount`,`lastNotificationAt`,`userMode`) VALUES (?,?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        statement.bindString(7, entity.getUserMode());
      }
    };
      ...
      public List<PlatformConfig> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new PlatformConfig(_tmpPackageName,_tmpDisplayName,_tmpCustomDisplayName,_tmpIsEnabled,_tmpNotificationCount,_tmpLastNotificationAt,_tmpUserMode);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public PlatformConfig call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final String _tmpUserMode;
            _tmpUserMode = _cursor.getString(_cursorIndexOfUserMode);
            _result = new PlatformConfig(_tmpPackageName,_tmpDisplayName,_tmpCustomDisplayName,_tmpIsEnabled,_tmpNotificationCount,_tmpLastNotificationAt,_tmpUserMode);
          } else {
            _result = null;
          }
          return _result;
