...
android {
    ...
    signingConfigs {
        create("release") {
            ...
            //   2. notifetch-android/upload-keystore.jks + keystore.properties (auto-generated by build-playstore.sh if missing)
            //   3. Falls back to debug signing (build will succeed but AAB won't be Play-Store uploadable)
            ...
            if (storeFileToUse != null) {
                ...
                if (keystoreProps.exists()) {
                    // Read credentials from keystore.properties (auto-generated)
                    val props = Properties().apply { load(keystoreProps.inputStream()) }
                    storePassword = props.getProperty("storePassword", "")
                    keyAlias = props.getProperty("keyAlias", "")
                    keyPassword = props.getProperty("keyPassword", "")
                } else {
                    // Read credentials from env vars (CI / manual build)
