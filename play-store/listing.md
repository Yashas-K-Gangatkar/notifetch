# NotiFetch — Google Play Store Listing
...
```
Track all delivery notifications in one place. Never miss an order update again.
```
...
Rationale: The app does not contain violence, sexual content, profanity, controlled substances, gambling, or user-generated content. It simply reads and organizes notification data from other apps.
...
> ⚠️ **TODO**: Set up this email address before Play Store submission. Consider using Google Workspace or a professional email service.
...
- **Play Console requirements**: 512x512 PNG, 32-bit PNG with alpha
- **Do not include**: Promotional text, badge, or device framing in the icon

---

## Feature Graphic (1024x500)

- **Required for**: Store listing visibility and featuring
- **Specifications**: 1024px × 500px, JPEG or 24-bit PNG (no alpha)
- **Content**: NotiFetch branding with tagline on the amber/dark theme
- **TODO**: Design and create this graphic

---

## Screenshots Required

### Phone Screenshots (mandatory — at least 2, max 8)

| # | Type | Description | Size |
|---|------|-------------|------|
| 1 | Dashboard | Main notification feed showing categorized delivery alerts | 1080×1920 or 1080×2400 |
| 2 | Platform View | Filtered view showing notifications from a specific platform | 1080×1920 or 1080×2400 |
| 3 | Earnings | Earnings tracker with daily/weekly/monthly charts | 1080×1920 or 1080×2400 |
| 4 | Settings | App settings and notification preferences | 1080×1920 or 1080×2400 |
| 5 | Onboarding | Notification permission setup screen | 1080×1920 or 1080×2400 |

### 7-inch Tablet Screenshots (optional)

| # | Description | Size |
|---|-------------|------|
| 1 | Dashboard tablet layout | 1200×1920 |

### 10-inch Tablet Screenshots (optional)

| # | Description | Size |
|---|-------------|------|
| 1 | Dashboard tablet layout | 1600×2560 |

> **Note**: Screenshots should use the app's actual UI on a clean device (no status bar clutter). Use the amber (#f59e0b) and dark (#0a0a0a) theme consistently.
...
| Does your app allow digital purchases? | Yes (Premium subscription via Razorpay) |
| Does your app allow user interaction? | No |
| Does your app share user data with third parties? | No |
| Does your app collect user data? | Yes (notification metadata, email, FCM token) |
...
### Digital Purchases
- **Type**: Subscription
- **Description**: NotiFetch Premium subscription for advanced analytics, unlimited history, and custom alert rules
- **Payment processor**: Razorpay (not Google Play Billing, as this is a TWA)

> ⚠️ **IMPORTANT**: As a TWA, purchases are processed through the web app via Razorpay. Google Play's payment policy may require clarification. Consider whether Google Play Billing is required for digital goods sold within the TWA.
...
- **Experiment A**: Title "NotiFetch: Delivery Tracker" vs "NotiFetch: All Notifications"
- **Experiment B**: Icon variations (current amber vs. alternative designs)
- **Experiment C**: Screenshot order and selection
...
- [ ] Digital purchase policy compliance verified
