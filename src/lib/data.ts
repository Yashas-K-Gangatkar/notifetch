...
export const PLATFORMS: Platform[] = [
  ...
  { id: "getir", name: "Getir", category: "grocery", regions: ["europe", "mena"], color: "text-purple-400", bgColor: "bg-purple-500/10", borderColor: "border-purple-500/30", icon: "⚡", connected: false, notificationsToday: 7, earningsToday: 25.00, currency: "EUR" },
  ...
  { id: "blinkit", name: "Blinkit", category: "grocery", regions: ["india"], color: "text-yellow-400", bgColor: "bg-yellow-500/10", borderColor: "border-yellow-500/30", icon: "⚡", connected: false, notificationsToday: 11, earningsToday: 720, currency: "INR" },
  { id: "mercado", name: "Mercado Libre Envios", category: "grocery", regions: ["latin-america"], color: "text-yellow-400", bgColor: "bg-yellow-500/10", borderColor: "border-yellow-500/30", icon: "📦", connected: false, notificationsToday: 5, earningsToday: 45.00, currency: "BRL" },
  { id: "woolworths", name: "Woolworths Delivery", category: "grocery", regions: ["oceania"], color: "text-green-400", bgColor: "bg-green-500/10", borderColor: "border-green-500/30", icon: "🟢", connected: false, notificationsToday: 4, earningsToday: 38.00, currency: "AUD" },
  ...
  { id: "fedex", name: "FedEx Delivery", category: "package", regions: ["north-america", "europe", "mena", "sea", "oceania"], color: "text-purple-400", bgColor: "bg-purple-500/10", borderColor: "border-purple-500/30", icon: "🟪", connected: false, notificationsToday: 5, earningsToday: 48.00, currency: "USD" },
  { id: "ups", name: "UPS Driver", category: "package", regions: ["north-america", "europe"], color: "text-amber-400", bgColor: "bg-amber-500/10", borderColor: "border-amber-500/30", icon: "🟫", connected: false, notificationsToday: 4, earningsToday: 42.00, currency: "USD" },
  { id: "dhl", name: "DHL Express", category: "package", regions: ["europe", "mena", "sea", "east-asia", "oceania"], color: "text-yellow-400", bgColor: "bg-yellow-500/10", borderColor: "border-yellow-500/30", icon: "🟡", connected: false, notificationsToday: 6, earningsToday: 45.00, currency: "EUR" },
  { id: "dunzo", name: "Dunzo", category: "package", regions: ["india"], color: "text-cyan-400", bgColor: "bg-cyan-500/10", borderColor: "border-cyan-500/30", icon: "🏃", connected: false, notificationsToday: 8, earningsToday: 550, currency: "INR" },
  { id: "lalamove", name: "Lalamove", category: "package", regions: ["sea", "east-asia", "mena"], color: "text-orange-400", bgColor: "bg-orange-500/10", borderColor: "border-orange-500/30", icon: "🚚", connected: false, notificationsToday: 7, earningsToday: 85.00, currency: "SGD" },
  { id: "borzo", name: "Borzo (WeFast)", category: "package", regions: ["india", "sea", "mena", "latin-america"], color: "text-green-400", bgColor: "bg-green-500/10", borderColor: "border-green-500/30", icon: "🟢", connected: false, notificationsToday: 5, earningsToday: 420, currency: "INR" },
  ...
  // ── Last-Mile Delivery ─────────────────────────────────────────────────────
  { id: "amazon-logistics", name: "Amazon Logistics", category: "last-mile", regions: ["north-america", "europe", "india", "oceania"], color: "text-teal-400", bgColor: "bg-teal-500/10", borderColor: "border-teal-500/30", icon: "📮", connected: false, notificationsToday: 8, earningsToday: 55.00, currency: "USD" },
  { id: "flipkart-logistics", name: "Flipkart Logistics", category: "last-mile", regions: ["india"], color: "text-blue-400", bgColor: "bg-blue-500/10", borderColor: "border-blue-500/30", icon: "📦", connected: false, notificationsToday: 10, earningsToday: 680, currency: "INR" },
  { id: "sf-express", name: "SF Express", category: "last-mile", regions: ["east-asia"], color: "text-red-400", bgColor: "bg-red-500/10", borderColor: "border-red-500/30", icon: "📮", connected: false, notificationsToday: 12, earningsToday: 320, currency: "CNY" },
  { id: "jne", name: "JNE", category: "last-mile", regions: ["sea"], color: "text-orange-400", bgColor: "bg-orange-500/10", borderColor: "border-orange-500/30", icon: "📬", connected: false, notificationsToday: 6, earningsToday: 85000, currency: "IDR" },
  { id: "aramex", name: "Aramex", category: "last-mile", regions: ["mena", "sea"], color: "text-blue-400", bgColor: "bg-blue-500/10", borderColor: "border-blue-500/30", icon: "📦", connected: false, notificationsToday: 5, earningsToday: 95.00, currency: "AED" },

  // ── Medical & Pharmacy ─────────────────────────────────────────────────────
  { id: "capsule", name: "Capsule", category: "medical", regions: ["north-america"], color: "text-blue-400", bgColor: "bg-blue-500/10", borderColor: "border-blue-500/30", icon: "💊", connected: false, notificationsToday: 3, earningsToday: 28.00, currency: "USD" },
  { id: "nowrx", name: "NowRx", category: "medical", regions: ["north-america"], color: "text-emerald-400", bgColor: "bg-emerald-500/10", borderColor: "border-emerald-500/30", icon: "💉", connected: false, notificationsToday: 2, earningsToday: 22.00, currency: "USD" },
  { id: "pharmeasy", name: "PharmEasy", category: "medical", regions: ["india"], color: "text-teal-400", bgColor: "bg-teal-500/10", borderColor: "border-teal-500/30", icon: "💊", connected: false, notificationsToday: 5, earningsToday: 380, currency: "INR" },
  { id: "netmeds", name: "Netmeds", category: "medical", regions: ["india"], color: "text-red-400", bgColor: "bg-red-500/10", borderColor: "border-red-500/30", icon: "🏥", connected: false, notificationsToday: 4, earningsToday: 320, currency: "INR" },
  { id: "1mg", name: "1mg", category: "medical", regions: ["india"], color: "text-orange-400", bgColor: "bg-orange-500/10", borderColor: "border-orange-500/30", icon: "💊", connected: false, notificationsToday: 3, earningsToday: 290, currency: "INR" },

  // ── Alcohol Delivery ───────────────────────────────────────────────────────
  { id: "drizly", name: "Drizly", category: "alcohol", regions: ["north-america"], color: "text-purple-400", bgColor: "bg-purple-500/10", borderColor: "border-purple-500/30", icon: "🍷", connected: false, notificationsToday: 4, earningsToday: 35.00, currency: "USD" },
  { id: "minibar", name: "Minibar", category: "alcohol", regions: ["north-america"], color: "text-amber-400", bgColor: "bg-amber-500/10", borderColor: "border-amber-500/30", icon: "🍸", connected: false, notificationsToday: 3, earningsToday: 28.00, currency: "USD" },
  { id: "saucey", name: "Saucey", category: "alcohol", regions: ["north-america"], color: "text-orange-400", bgColor: "bg-orange-500/10", borderColor: "border-orange-500/30", icon: "🍺", connected: false, notificationsToday: 2, earningsToday: 22.00, currency: "USD" },
  { id: "hipbar", name: "HipBar", category: "alcohol", regions: ["india"], color: "text-rose-400", bgColor: "bg-rose-500/10", borderColor: "border-rose-500/30", icon: "🥂", connected: false, notificationsToday: 2, earningsToday: 240, currency: "INR" },

  // ── Flower Delivery ────────────────────────────────────────────────────────
  { id: "bloomnation", name: "BloomNation", category: "flower", regions: ["north-america"], color: "text-pink-400", bgColor: "bg-pink-500/10", borderColor: "border-pink-500/30", icon: "💐", connected: false, notificationsToday: 2, earningsToday: 25.00, currency: "USD" },
  { id: "1800-flowers", name: "1-800-Flowers", category: "flower", regions: ["north-america"], color: "text-pink-400", bgColor: "bg-pink-500/10", borderColor: "border-pink-500/30", icon: "🌸", connected: false, notificationsToday: 3, earningsToday: 30.00, currency: "USD" },
  { id: "interflora", name: "Interflora", category: "flower", regions: ["europe", "oceania"], color: "text-rose-400", bgColor: "bg-rose-500/10", borderColor: "border-rose-500/30", icon: "🌹", connected: false, notificationsToday: 2, earningsToday: 22.00, currency: "EUR" },
  { id: "ferns-petals", name: "Ferns N Petals", category: "flower", regions: ["india"], color: "text-green-400", bgColor: "bg-green-500/10", borderColor: "border-green-500/30", icon: "🌺", connected: false, notificationsToday: 3, earningsToday: 280, currency: "INR" },

  // ── Laundry & Dry Cleaning ─────────────────────────────────────────────────
  { id: "rinse", name: "Rinse", category: "laundry", regions: ["north-america"], color: "text-cyan-400", bgColor: "bg-cyan-500/10", borderColor: "border-cyan-500/30", icon: "👔", connected: false, notificationsToday: 3, earningsToday: 28.00, currency: "USD" },
  { id: "flycleaners", name: "FlyCleaners", category: "laundry", regions: ["north-america"], color: "text-sky-400", bgColor: "bg-sky-500/10", borderColor: "border-sky-500/30", icon: "🧺", connected: false, notificationsToday: 2, earningsToday: 22.00, currency: "USD" },
  { id: "laundrokart", name: "LaundroKart", category: "laundry", regions: ["india"], color: "text-blue-400", bgColor: "bg-blue-500/10", borderColor: "border-blue-500/30", icon: "👕", connected: false, notificationsToday: 3, earningsToday: 180, currency: "INR" },
  { id: "presso", name: "Presso", category: "laundry", regions: ["sea", "mena"], color: "text-indigo-400", bgColor: "bg-indigo-500/10", borderColor: "border-indigo-500/30", icon: "🧺", connected: false, notificationsToday: 2, earningsToday: 45.00, currency: "AED" },

  // ── Pet Supplies ───────────────────────────────────────────────────────────
  { id: "chewy", name: "Chewy", category: "pet-supplies", regions: ["north-america"], color: "text-yellow-400", bgColor: "bg-yellow-500/10", borderColor: "border-yellow-500/30", icon: "🐕", connected: false, notificationsToday: 2, earningsToday: 18.00, currency: "USD" },
  { id: "pets-at-home", name: "Pets at Home", category: "pet-supplies", regions: ["europe"], color: "text-red-400", bgColor: "bg-red-500/10", borderColor: "border-red-500/30", icon: "🐾", connected: false, notificationsToday: 1, earningsToday: 15.00, currency: "GBP" },
  { id: "heads-up-for-tails", name: "Heads Up For Tails", category: "pet-supplies", regions: ["india"], color: "text-amber-400", bgColor: "bg-amber-500/10", borderColor: "border-amber-500/30", icon: "🐱", connected: false, notificationsToday: 2, earningsToday: 220, currency: "INR" },

  // ── Freight & Trucking ─────────────────────────────────────────────────────
  { id: "convoy", name: "Convoy", category: "freight", regions: ["north-america"], color: "text-amber-400", bgColor: "bg-amber-500/10", borderColor: "border-amber-500/30", icon: "🚛", connected: false, notificationsToday: 2, earningsToday: 180.00, currency: "USD" },
  { id: "uber-freight", name: "Uber Freight", category: "freight", regions: ["north-america", "europe"], color: "text-emerald-400", bgColor: "bg-emerald-500/10", borderColor: "border-emerald-500/30", icon: "🚚", connected: false, notificationsToday: 3, earningsToday: 220.00, currency: "USD" },
  { id: "blackbuck", name: "BlackBuck", category: "freight", regions: ["india"], color: "text-stone-400", bgColor: "bg-stone-500/10", borderColor: "border-stone-500/30", icon: "🚛", connected: false, notificationsToday: 2, earningsToday: 3500, currency: "INR" },

  // ── Furniture & Appliance ──────────────────────────────────────────────────
  { id: "wayfair-delivery", name: "Wayfair Delivery", category: "furniture", regions: ["north-america", "europe"], color: "text-stone-400", bgColor: "bg-stone-500/10", borderColor: "border-stone-500/30", icon: "🛋️", connected: false, notificationsToday: 1, earningsToday: 85.00, currency: "USD" },
  { id: "castlery", name: "Castlery", category: "furniture", regions: ["sea", "oceania"], color: "text-amber-400", bgColor: "bg-amber-500/10", borderColor: "border-amber-500/30", icon: "🪑", connected: false, notificationsToday: 1, earningsToday: 65.00, currency: "SGD" },
  { id: "urban-ladder", name: "Urban Ladder", category: "furniture", regions: ["india"], color: "text-orange-400", bgColor: "bg-orange-500/10", borderColor: "border-orange-500/30", icon: "🛋️", connected: false, notificationsToday: 1, earningsToday: 850, currency: "INR" },

  // ── Bicycle Courier ────────────────────────────────────────────────────────
  { id: "uber-connect", name: "Uber Connect", category: "bicycle-courier", regions: ["north-america", "india", "sea", "latin-america"], color: "text-lime-400", bgColor: "bg-lime-500/10", borderColor: "border-lime-500/30", icon: "🚲", connected: false, notificationsToday: 5, earningsToday: 32.00, currency: "USD" },
  { id: "courier-please", name: "Courier Please", category: "bicycle-courier", regions: ["oceania"], color: "text-green-400", bgColor: "bg-green-500/10", borderColor: "border-green-500/30", icon: "🚴", connected: false, notificationsToday: 3, earningsToday: 42.00, currency: "AUD" },

  // ── Ride & Transport ──────────────────────────────────────────────────────
  { id: "uber-driver", name: "Uber Driver", category: "ride-transport", regions: ["north-america", "europe", "india", "sea", "mena", "latin-america", "oceania"], color: "text-violet-400", bgColor: "bg-violet-500/10", borderColor: "border-violet-500/30", icon: "🚗", connected: false, notificationsToday: 15, earningsToday: 95.00, currency: "USD" },
  { id: "lyft-driver", name: "Lyft Driver", category: "ride-transport", regions: ["north-america"], color: "text-pink-400", bgColor: "bg-pink-500/10", borderColor: "border-pink-500/30", icon: "🌸", connected: false, notificationsToday: 10, earningsToday: 72.00, currency: "USD" },
  { id: "ola-driver", name: "Ola Driver", category: "ride-transport", regions: ["india", "oceania"], color: "text-yellow-400", bgColor: "bg-yellow-500/10", borderColor: "border-yellow-500/30", icon: "🟡", connected: false, notificationsToday: 12, earningsToday: 890, currency: "INR" },
  { id: "grab-driver", name: "Grab Driver", category: "ride-transport", regions: ["sea"], color: "text-green-400", bgColor: "bg-green-500/10", borderColor: "border-green-500/30", icon: "🟢", connected: false, notificationsToday: 14, earningsToday: 95.00, currency: "SGD" },
  { id: "careem", name: "Careem", category: "ride-transport", regions: ["mena"], color: "text-green-400", bgColor: "bg-green-500/10", borderColor: "border-green-500/30", icon: "🟢", connected: false, notificationsToday: 8, earningsToday: 110, currency: "AED" },
  { id: "didi", name: "DiDi", category: "ride-transport", regions: ["east-asia", "latin-america", "oceania"], color: "text-orange-400", bgColor: "bg-orange-500/10", borderColor: "border-orange-500/30", icon: "🟧", connected: false, notificationsToday: 11, earningsToday: 260, currency: "CNY" },
  { id: "bolt", name: "Bolt", category: "ride-transport", regions: ["europe", "mena", "sea"], color: "text-green-400", bgColor: "bg-green-500/10", borderColor: "border-green-500/30", icon: "⚡", connected: false, notificationsToday: 9, earningsToday: 48.00, currency: "EUR" },

  // ── Document Delivery ──────────────────────────────────────────────────────
  { id: "dex", name: "Dex", category: "document", regions: ["north-america"], color: "text-slate-400", bgColor: "bg-slate-500/10", borderColor: "border-slate-500/30", icon: "📄", connected: false, notificationsToday: 2, earningsToday: 18.00, currency: "USD" },
  { id: "couriire", name: "Couriire", category: "document", regions: ["india"], color: "text-indigo-400", bgColor: "bg-indigo-500/10", borderColor: "border-indigo-500/30", icon: "📋", connected: false, notificationsToday: 3, earningsToday: 220, currency: "INR" },

  // ── Same-Day Delivery ──────────────────────────────────────────────────────
  { id: "shipt", name: "Shipt", category: "same-day", regions: ["north-america"], color: "text-green-400", bgColor: "bg-green-500/10", borderColor: "border-green-500/30", icon: "⚡", connected: false, notificationsToday: 5, earningsToday: 38.00, currency: "USD" },
  { id: "cainiao", name: "Cainiao", category: "same-day", regions: ["east-asia"], color: "text-red-400", bgColor: "bg-red-500/10", borderColor: "border-red-500/30", icon: "⚡", connected: false, notificationsToday: 8, earningsToday: 180, currency: "CNY" },
  { id: "ninja-van", name: "Ninja Van", category: "same-day", regions: ["sea"], color: "text-orange-400", bgColor: "bg-orange-500/10", borderColor: "border-orange-500/30", icon: "🥷", connected: false, notificationsToday: 4, earningsToday: 55.00, currency: "SGD" },

  // ── White-Glove ────────────────────────────────────────────────────────────
  { id: "xpo", name: "XPO Logistics", category: "white-glove", regions: ["north-america", "europe"], color: "text-fuchsia-400", bgColor: "bg-fuchsia-500/10", borderColor: "border-fuchsia-500/30", icon: "🤝", connected: false, notificationsToday: 1, earningsToday: 150.00, currency: "USD" },
  { id: "jd-logistics", name: "JD Logistics", category: "white-glove", regions: ["east-asia"], color: "text-red-400", bgColor: "bg-red-500/10", borderColor: "border-red-500/30", icon: "🤝", connected: false, notificationsToday: 2, earningsToday: 350, currency: "CNY" },
...
export const PRICING: Record<string, { free: number; premium: number; currency: string }> = {
  "north-america": { free: 0, premium: 9.99, currency: "USD" },
  "europe": { free: 0, premium: 8.99, currency: "EUR" },
  "india": { free: 0, premium: 499, currency: "INR" },
  "east-asia": { free: 0, premium: 1200, currency: "JPY" },
  "sea": { free: 0, premium: 12.99, currency: "SGD" },
  "mena": { free: 0, premium: 34.99, currency: "AED" },
  "latin-america": { free: 0, premium: 24.90, currency: "BRL" },
  "oceania": { free: 0, premium: 14.99, currency: "AUD" },
};
