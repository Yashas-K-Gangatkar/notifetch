...
export const PLATFORMS: Platform[] = [
  // ── Food Delivery ──────────────────────────────────────────────────────────
  { id: "uber-eats", name: "Food Delivery Platform", category: "food", regions: ["north-america", "europe", "india", "sea", "mena", "latin-america", "oceania"], color: "text-emerald-400", bgColor: "bg-emerald-500/10", borderColor: "border-emerald-500/30", icon: "🟢", connected: true, notificationsToday: 24, earningsToday: 87.50, currency: "USD" },
  { id: "doordash", name: "Food Delivery Platform 2", category: "food", regions: ["north-america", "oceania"], color: "text-red-400", bgColor: "bg-red-500/10", borderColor: "border-red-500/30", icon: "🔴", connected: true, notificationsToday: 18, earningsToday: 62.30, currency: "USD" },
  { id: "grubhub", name: "Food Delivery Platform 3", category: "food", regions: ["north-america"], color: "text-yellow-400", bgColor: "bg-yellow-500/10", borderColor: "border-yellow-500/30", icon: "🟡", connected: false, notificationsToday: 8, earningsToday: 31.20, currency: "USD" },
  { id: "deliveroo", name: "Food Delivery Platform 4", category: "food", regions: ["europe", "mena", "sea"], color: "text-teal-400", bgColor: "bg-teal-500/10", borderColor: "border-teal-500/30", icon: "🦘", connected: true, notificationsToday: 15, earningsToday: 48.00, currency: "EUR" },
  { id: "just-eat", name: "Food Delivery Platform 5", category: "food", regions: ["europe"], color: "text-orange-400", bgColor: "bg-orange-500/10", borderColor: "border-orange-500/30", icon: "🟠", connected: false, notificationsToday: 12, earningsToday: 42.50, currency: "EUR" },
  { id: "foodpanda", name: "Food Delivery Platform 6", category: "food", regions: ["sea", "mena", "east-asia"], color: "text-pink-400", bgColor: "bg-pink-500/10", borderColor: "border-pink-500/30", icon: "🐼", connected: false, notificationsToday: 10, earningsToday: 35.00, currency: "SGD" },
  { id: "swiggy", name: "Food Delivery Platform 7", category: "food", regions: ["india"], color: "text-amber-400", bgColor: "bg-amber-500/10", borderColor: "border-amber-500/30", icon: "🔥", connected: true, notificationsToday: 22, earningsToday: 1200, currency: "INR" },
  { id: "zomato", name: "Food Delivery Platform 8", category: "food", regions: ["india"], color: "text-red-400", bgColor: "bg-red-500/10", borderColor: "border-red-500/30", icon: "🍅", connected: true, notificationsToday: 19, earningsToday: 980, currency: "INR" },
  { id: "ifood", name: "Food Delivery Platform 9", category: "food", regions: ["latin-america"], color: "text-purple-400", bgColor: "bg-purple-500/10", borderColor: "border-purple-500/30", icon: "🟣", connected: false, notificationsToday: 14, earningsToday: 85.00, currency: "BRL" },
  { id: "rappi", name: "Food Delivery Platform 10", category: "food", regions: ["latin-america"], color: "text-orange-400", bgColor: "bg-orange-500/10", borderColor: "border-orange-500/30", icon: "🟧", connected: false, notificationsToday: 11, earningsToday: 65.00, currency: "COP" },
  { id: "wolt", name: "Food Delivery Platform 11", category: "food", regions: ["europe", "mena", "east-asia"], color: "text-sky-400", bgColor: "bg-sky-500/10", borderColor: "border-sky-500/30", icon: "🔵", connected: false, notificationsToday: 9, earningsToday: 38.00, currency: "EUR" },
  { id: "glovo", name: "Food Delivery Platform 12", category: "food", regions: ["europe", "mena", "sea"], color: "text-yellow-400", bgColor: "bg-yellow-500/10", borderColor: "border-yellow-500/30", icon: "🟨", connected: false, notificationsToday: 7, earningsToday: 28.00, currency: "EUR" },
  { id: "meituan", name: "Food Delivery Platform 13", category: "food", regions: ["east-asia"], color: "text-yellow-400", bgColor: "bg-yellow-500/10", borderColor: "border-yellow-500/30", icon: "🟡", connected: false, notificationsToday: 25, earningsToday: 350, currency: "CNY" },
  { id: "ele-me", name: "Food Delivery Platform 14", category: "food", regions: ["east-asia"], color: "text-blue-400", bgColor: "bg-blue-500/10", borderColor: "border-blue-500/30", icon: "🐝", connected: false, notificationsToday: 20, earningsToday: 280, currency: "CNY" },
  { id: "demae-can", name: "Food Delivery Platform 15", category: "food", regions: ["east-asia"], color: "text-red-400", bgColor: "bg-red-500/10", borderColor: "border-red-500/30", icon: "🍱", connected: false, notificationsToday: 8, earningsToday: 4500, currency: "JPY" },
  { id: "talabat", name: "Food Delivery Platform 16", category: "food", regions: ["mena"], color: "text-orange-400", bgColor: "bg-orange-500/10", borderColor: "border-orange-500/30", icon: "🟠", connected: false, notificationsToday: 13, earningsToday: 120, currency: "AED" },
  { id: "menulog", name: "Food Delivery Platform 17", category: "food", regions: ["oceania"], color: "text-purple-400", bgColor: "bg-purple-500/10", borderColor: "border-purple-500/30", icon: "📋", connected: false, notificationsToday: 6, earningsToday: 45.00, currency: "AUD" },

  // ── Grocery Delivery ───────────────────────────────────────────────────────
  { id: "instacart", name: "Grocery Delivery Platform", category: "grocery", regions: ["north-america"], color: "text-orange-400", bgColor: "bg-orange-500/10", borderColor: "border-orange-500/30", icon: "🥕", connected: true, notificationsToday: 12, earningsToday: 45.80, currency: "USD" },
  { id: "gopuff", name: "Grocery Delivery Platform 2", category: "grocery", regions: ["north-america", "europe"], color: "text-purple-400", bgColor: "bg-purple-500/10", borderColor: "border-purple-500/30", icon: "🟣", connected: false, notificationsToday: 8, earningsToday: 32.00, currency: "USD" },
  { id: "gorillas", name: "Grocery Delivery Platform 3", category: "grocery", regions: ["europe"], color: "text-lime-400", bgColor: "bg-lime-500/10", borderColor: "border-lime-500/30", icon: "🦍", connected: false, notificationsToday: 6, earningsToday: 28.00, currency: "EUR" },
  { id: "getir", name: "Grocery Delivery Platform 4", category: "grocery", regions: ["europe", "mena"], color: "text-purple-400", bgColor: "bg-purple-500/10", borderColor: "border-purple-500/30", icon: "⚡", connected: false, notificationsToday: 7, earningsToday: 25.00, currency: "EUR" },
  { id: "bigbasket", name: "Grocery Delivery Platform 5", category: "grocery", regions: ["india"], color: "text-red-400", bgColor: "bg-red-500/10", borderColor: "border-red-500/30", icon: "🛒", connected: false, notificationsToday: 9, earningsToday: 650, currency: "INR" },
  { id: "blinkit", name: "Grocery Delivery Platform 6", category: "grocery", regions: ["india"], color: "text-yellow-400", bgColor: "bg-yellow-500/10", borderColor: "border-yellow-500/30", icon: "⚡", connected: false, notificationsToday: 11, earningsToday: 720, currency: "INR" },
  { id: "mercado", name: "Grocery Delivery Platform 7", category: "grocery", regions: ["latin-america"], color: "text-yellow-400", bgColor: "bg-yellow-500/10", borderColor: "border-yellow-500/30", icon: "📦", connected: false, notificationsToday: 5, earningsToday: 45.00, currency: "BRL" },
  { id: "woolworths", name: "Grocery Delivery Platform 8", category: "grocery", regions: ["oceania"], color: "text-green-400", bgColor: "bg-green-500/10", borderColor: "border-green-500/30", icon: "🟢", connected: false, notificationsToday: 4, earningsToday: 38.00, currency: "AUD" },

  // ── Package & Parcel ───────────────────────────────────────────────────────
  { id: "amazon-flex", name: "Package Delivery Platform", category: "package", regions: ["north-america", "europe", "india", "oceania", "sea"], color: "text-teal-400", bgColor: "bg-teal-500/10", borderColor: "border-teal-500/30", icon: "📦", connected: true, notificationsToday: 6, earningsToday: 52.40, currency: "USD" },
  { id: "fedex", name: "Package Delivery Platform 2", category: "package", regions: ["north-america", "europe", "mena", "sea", "oceania"], color: "text-purple-400", bgColor: "bg-purple-500/10", borderColor: "border-purple-500/30", icon: "🟪", connected: false, notificationsToday: 5, earningsToday: 48.00, currency: "USD" },
  { id: "ups", name: "Package Delivery Platform 3", category: "package", regions: ["north-america", "europe"], color: "text-amber-400", bgColor: "bg-amber-500/10", borderColor: "border-amber-500/30", icon: "🟫", connected: false, notificationsToday: 4, earningsToday: 42.00, currency: "USD" },
  { id: "dhl", name: "Package Delivery Platform 4", category: "package", regions: ["europe", "mena", "sea", "east-asia", "oceania"], color: "text-yellow-400", bgColor: "bg-yellow-500/10", borderColor: "border-yellow-500/30", icon: "🟡", connected: false, notificationsToday: 6, earningsToday: 45.00, currency: "EUR" },
  { id: "dunzo", name: "Package Delivery Platform 5", category: "package", regions: ["india"], color: "text-cyan-400", bgColor: "bg-cyan-500/10", borderColor: "border-cyan-500/30", icon: "🏃", connected: false, notificationsToday: 8, earningsToday: 550, currency: "INR" },
  { id: "lalamove", name: "Package Delivery Platform 6", category: "package", regions: ["sea", "east-asia", "mena"], color: "text-orange-400", bgColor: "bg-orange-500/10", borderColor: "border-orange-500/30", icon: "🚚", connected: false, notificationsToday: 7, earningsToday: 85.00, currency: "SGD" },
  { id: "borzo", name: "Package Delivery Platform 7", category: "package", regions: ["india", "sea", "mena", "latin-america"], color: "text-green-400", bgColor: "bg-green-500/10", borderColor: "border-green-500/30", icon: "🟢", connected: false, notificationsToday: 5, earningsToday: 420, currency: "INR" },

  // ── Courier & Express ──────────────────────────────────────────────────────
  { id: "postmates", name: "Courier Platform", category: "courier", regions: ["north-america"], color: "text-yellow-400", bgColor: "bg-yellow-500/10", borderColor: "border-yellow-500/30", icon: "🛵", connected: false, notificationsToday: 9, earningsToday: 38.00, currency: "USD" },
  ...
  { id: "deliv", name: "Courier Platform 3", category: "courier", regions: ["north-america"], color: "text-sky-400", bgColor: "bg-sky-500/10", borderColor: "border-sky-500/30", icon: "🚐", connected: false, notificationsToday: 3, earningsToday: 35.00, currency: "USD" },
  { id: "stuart", name: "Courier Platform 4", category: "courier", regions: ["europe"], color: "text-indigo-400", bgColor: "bg-indigo-500/10", borderColor: "border-indigo-500/30", icon: "🚴", connected: false, notificationsToday: 5, earningsToday: 32.00, currency: "EUR" },
  { id: "gogo-xpress", name: "Courier Platform 5", category: "courier", regions: ["sea"], color: "text-orange-400", bgColor: "bg-orange-500/10", borderColor: "border-orange-500/30", icon: "📦", connected: false, notificationsToday: 4, earningsToday: 380, currency: "PHP" },
